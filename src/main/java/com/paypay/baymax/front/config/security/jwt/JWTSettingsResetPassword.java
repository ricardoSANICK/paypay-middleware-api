...
@Configuration
@ConfigurationProperties(prefix = "com.paypay.baymax.security.jwtresetpwd")
public class JWTSettingsResetPassword {
	...
	public Integer getTokenExpirationTime() {
		return tokenExpirationTime != null ? tokenExpirationTime : getMaxInactiveInterval() * 60;
	}
